...
class HangmanGame(QWidget):
    ...
    def guessClicked(self):
        ...
        # 이미 사용한 글자인지를 단하고, 아닌 경우 메시지 출력, 리턴
        if guessedChar in self.guess.guessedChars:
            self.message.setText("already use")
        else:
            list(self.guess.guessedChars).append(guessedChar)
