...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        def_list = [calcFunctions4.factorial, calcFunctions4.decToBin, calcFunctions4.binToDec, calcFunctions4.decToRoman,calcFunctions4.romanToDec]
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text() + constantList.get(key))
